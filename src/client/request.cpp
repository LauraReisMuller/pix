/**
 * Gerencia o envio de pedidos (PKT_REQUEST) ao servidor e espera por ACKs.
 *
 * Implementa retransmissão com timeout (RRA) e matching de sequence numbers (seqn).
 * Quando recebe um ACK válido, encaminha-o para `ClientInterface` para apresentação.
 */
